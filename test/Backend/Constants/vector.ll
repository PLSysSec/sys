...
define i32 @add(i32, i32) local_unnamed_addr #0 {
  %3 = extractelement <4 x i32> <i32 0, i32 1, i32 2, i32 3>, i32 0
  %4 = extractelement <4 x i32> <i32 0, i32 1, i32 2, i32 3>, i32 1	
  %5 = extractelement <4 x i32> <i32 0, i32 1, i32 2, i32 3>, i32 2
  %6 = extractelement <4 x i32> <i32 0, i32 1, i32 2, i32 3>, i32 3
  %7 = add i32 %3, %4
  %8 = add i32 %5, %6
  ret i32 0
}
