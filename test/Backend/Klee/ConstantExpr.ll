...
define i32 @main() {
    ...
    %inttoptr = call i8 @test_int_to_ptr()
    %inttoptrdep = add i8 %inttoptr, %inttoptr     	      	

    %constantops = call i8 @test_constant_ops()
    %constantopsdep = add i8 %constantops, %constantops    		 
